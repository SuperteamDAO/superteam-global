<script>
	import podcast from '../assets/cards/podcast_new.webp';
	import blog from '../assets/cards/blog_new.webp';
</script>

<div class="relative col-span-5 mt-[224px] flex flex-col justify-center text-center">
	<p
